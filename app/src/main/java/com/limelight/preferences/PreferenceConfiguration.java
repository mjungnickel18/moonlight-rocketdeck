...
public class PreferenceConfiguration {
    ...
    private static final String KSP_KEYBOARD_PREF_STRING = "checkbox_ksp_keyboard";
    ...
    private static final boolean DEFAULT_KSP_KEYBOARD = true;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.kspKeyboard = prefs.getBoolean(KSP_KEYBOARD_PREF_STRING, DEFAULT_KSP_KEYBOARD);
